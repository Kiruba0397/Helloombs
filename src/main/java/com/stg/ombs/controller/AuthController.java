...
import com.stg.ombs.service.UserDetailsImpl;
import com.stg.ombs.repository.UserRepository;
import com.stg.ombs.request.LoginRequest;
import com.stg.ombs.request.SignupRequest;
import com.stg.ombs.response.JwtResponse;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		if (strRoles == null) {
			Role userRole = roleRepository.findByName(ERole.ROLE_MAID)
			...
			strRoles.forEach(role -> {
				...
				case "visit":
					...
					break;
					case "maid":
						Role maidRole = roleRepository.findByName(ERole.ROLE_MAID)
								.orElseThrow(() -> new RuntimeException("Error: Role is not found."));
						roles.add(maidRole);
